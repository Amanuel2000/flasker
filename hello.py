...
def delete_post(id):
    ...
    if id == post_to_delete.poster.id:
        ...
        try:
            ...
            # return a message
            flash("Blog post was delted Successfully")
...
def add_user():
    ...
    if form.validate_on_submit():
        ...
        if user is None:
            ...
            user = Users(username = form.username.data, name=form.name.data, email=form.email.data,password_hash=hashed_pw, favorite_color=form.favorite_color.data)
            db.session.add(user)
            db.session.commit()
        name = form.name.data
        form.name.data = ''
